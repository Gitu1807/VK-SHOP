...
from shopapp.models import Home,Product, Cart,Order,About,Contact,Facebook,Instagram,Twitter
...
def home(request):
    p=Home.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
...
def facebook(request):
    p=Facebook.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
...
def instagram(request):
    p=Instagram.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
...
def twitter(request):
    p=Twitter.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
...
def about(request):
    p=About.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
...
def contact(request):
    p=Contact.objects.filter(is_active=True)
    # print(p)
    context={}
    context['data']=p
    ...
    if request.method=='GET':
        ...
        if n=='' or p=='' or cp=='':
            ...
            try:
                ...
                u.set_password(p)
                u.save()
                context['success']='User created Succeessfully'
                return render(request,'register.html',context)
            except Exception:
...
def paymentsuccess(request):
    sub='VK Shop Order Status'
    msg='Thanks for Shopping in VK Shop..!!'
